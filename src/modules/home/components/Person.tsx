...
const persons = [
  {
    name: 'L RMN',
    role: '',
    avatar: 'https://avatars.githubusercontent.com/u/97253349?v=4',
    github: 'https://github.com/lrmn7',
    www: 'https://lrmn.is-a.dev',
  },
];
...
const ProfileSocial = ({ github, www }: { github: string; www: string }) => (
  <div className="flex gap-4">
    <a href={github} target="_blank" rel="noreferrer">
      <Image src="/icons/github.svg" alt="github" width="24" height="24" />
    </a>
    <a href={www} target="_blank" rel="noreferrer">
      <Image src="/icons/www.svg" alt="www" width="24" height="24" />
    </a>
  </div>
);
    ...
    <>
      {persons.map((person) => (
        <PersonCard key={person.name}>
          ...
          <ProfileSocial github={person.github} www={person.www} />
        </PersonCard>
      ))}
    </>
  );
