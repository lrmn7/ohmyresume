    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} className="scroll-smooth">
        ...
        <div className="flex-auto flex justify-between items-center ml-5">
          <NavBarActions>
            <Link href="/" passHref={true}>
              <StyledButton variant="text">OhMyRESUME</StyledButton>
            </Link>
          </NavBarActions>
          <NavBarActions>
            <Link href="https://www.buymeacoffee.com/LRMN" passHref={true}>
          ...
          >
            ...
            <div className="col-span-12 sm:col-span-8">
              <h3 className="text-xl md:text-2xl mb-2 text-resume-400">
                The easiest way to build a professional resume
              </h3>
              <h2 className="text-5xl mb-12 text-resume-800">Create your resume with OhMyRESUME</h2>
        ...
        >
          <div className="grid grid-cols-12 items-center text-center">
            ...
            <div className="col-span-12 lg:col-span-3 mx-auto flex flex-col items-center gap-2">
              ...
              <div>
                <a href="https://github.com/lrmn7/ohmyresume" target="_blank" rel="noreferrer">
      ...
      >
        ...
        <p className="text-resume-400 my-8 text-center lg:text-left">
          View more projects&nbsp;
          <a href="https://lrmn.site/links" target="_blank" rel="noreferrer" className="underline">
            Here
          </a>
          ↗
        </p>
